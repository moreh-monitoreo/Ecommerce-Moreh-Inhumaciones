/* ============================================================
   Layout: inyecta sidebar + topbar en cada página admin
   ============================================================ */
(function () {
  ...
  const LINKS = [
    ...
    { section: 'OPERACIONES' },
    { href: 'ordenes.html',   icon: 'shopping-cart', label: 'Órdenes' },
    { href: 'contratos.html', icon: 'file-text', label: 'Contratos' },
    { href: 'clientes.html',  icon: 'users', label: 'Clientes' },
    { href: 'leads.html',     icon: 'inbox', label: 'Leads' },
    { section: 'ADMINISTRACIÓN' },
    { href: 'sucursales.html', icon: 'map-pin', label: 'Sucursales' },
  ...
  function buildNavLinks() {
    return LINKS.map(item => {
      ...
      return `<a href="${item.href}" class="sidebar-link${active}">${ICONS[item.icon] ?? ''}<span>${item.label}</span></a>`;
    }).join('');
  }
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
      <a href="dashboard.html" class="sidebar-brand">
        ...
        <div class="sidebar-brand-text">
          <span class="sidebar-brand-name">Moreh Admin</span>
          <span class="sidebar-brand-sub">Panel Administrativo</span>
        </div>
      </a>
      <nav class="sidebar-nav">${buildNavLinks()}</nav>
      <div class="sidebar-footer">
        <div class="sidebar-user-info">
          <div class="sidebar-avatar" id="sidebar-avatar">MA</div>
          <div>
            <span class="sidebar-user-name" id="sidebar-user-name">Cargando...</span>
            <span class="sidebar-user-role" id="sidebar-user-role">—</span>
          </div>
        </div>
        <button class="sidebar-logout" id="btn-logout">
          ${ICONS['log-out']}<span>Cerrar sesión</span>
        </button>
      </div>
    </aside>`;
  ...
  const topbarHTML = `
    <header class="admin-topbar">
      <div class="topbar-left">
        <button class="topbar-toggle" id="sidebar-toggle">${ICONS['menu']}</button>
        <div class="topbar-breadcrumb">
          Moreh Admin / <span id="topbar-page-title">Panel</span>
        </div>
      </div>
      <div class="topbar-right">
        <button class="topbar-badge" title="Notificaciones">
          ${ICONS['bell']}<span class="badge-dot"></span>
        </button>
      </div>
    </header>
